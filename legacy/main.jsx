// uture v1 — root with new interactive sections (kept separate from v2)
  ...
  return (
    <>
      ...
      <TweaksPanel title="Tweaks">
        ...
        <TweakSection label="커서 이펙트">
          <TweakToggle value={tweaks.cursorFx} onChange={(v) => setTweak('cursorFx', v)}/>
        </TweakSection>
      </TweaksPanel>
    </>
  );
