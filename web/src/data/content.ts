  ...
  tabs: [
    {
      ...
      label: 'Plan',
      icon: 'target',
      title: ['진단부터 도입까지', '플랜 & 운영'],
      desc: '조직 진단 데이터를 기반으로 도입 우선순위를 결정하고, 분기 단위로 점검합니다.',
      items: [
        { done: true, text: '사내 보안 정책 검토' },
        { done: true, text: '직무별 인터뷰 (32명)' },
        { done: false, text: '재무팀 워킹 미팅 W6' },
        { done: false, text: '정산 자동화 봇 v1 배포' },
      ],
    },
    {
      id: 'build',
      label: 'Build',
      icon: 'build',
      title: ['현장의 요구로', '함께 만드는 도구'],
      desc: '현장 미팅에서 발견한 요구 그대로, 사내 데이터 · 시스템과 연결되는 도구를 협업해 구축합니다.',
      code: [
        '# uture custom agent',
        'from uture import Agent',
        '',
        'agent = Agent(',
        '    domain="telco",',
        '    secure=True,',
    ...
    },
    {
      ...
      label: 'Workflow',
      icon: 'flow',
      title: ['업무 흐름에', '자동으로 녹여내기'],
      desc: '사내 SaaS · 메신저 · 문서 시스템과 연결된 AI 워크플로를 설계합니다.',
      flow: [
        { k: 'IN', v: 'Slack 메시지 수집' },
        { k: 'AI', v: 'uture Agent 분석' },
        { k: 'OUT', v: 'Confluence 자동 업로드' },
      ],
    },
  ],
}
